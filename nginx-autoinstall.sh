...
# Define versions
NGINX_MAINLINE_VER=${NGINX_MAINLINE_VER:-1.27.0}
NGINX_STABLE_VER=${NGINX_STABLE_VER:-1.26.2}
LIBRESSL_VER=${LIBRESSL_VER:-3.8.2}
OPENSSL_VER=${OPENSSL_VER:-3.2.1}
NPS_VER=${NPS_VER:-1.13.35.2}
HEADERMOD_VER=${HEADERMOD_VER:-0.37}
LIBMAXMINDDB_VER=${LIBMAXMINDDB_VER:-1.9.1}
GEOIP2_VER=${GEOIP2_VER:-3.4}
LUA_JIT_VER=${LUA_JIT_VER:-2.1-20231117}
LUA_NGINX_VER=${LUA_NGINX_VER:-0.10.26}
LUA_RESTYCORE_VER=${LUA_RESTYCORE_VER:-0.1.28}
